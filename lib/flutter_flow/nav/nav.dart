...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: MisEventosWidget.routeName,
          path: MisEventosWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'MisEventos')
              : MisEventosWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'Crear') : CrearWidget(),
        ),
        FFRoute(
          name: EventoWidget.routeName,
          path: EventoWidget.routePath,
          builder: (context, params) => EventoWidget(
            nParametro: params.getParam(
              'nParametro',
              ParamType.String,
            ),
            ...
            ciudadParametro: params.getParam(
              'ciudadParametro',
              ParamType.String,
            ),
            provinciaParametro: params.getParam(
              'provinciaParametro',
              ParamType.String,
            ),
            categoriaParametro: params.getParam(
              'categoriaParametro',
              ParamType.String,
            ),
            userIdParametro: params.getParam(
              'userIdParametro',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: DescubrirrWidget.routeName,
          path: DescubrirrWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'descubrirr')
              : DescubrirrWidget(),
        ),
        FFRoute(
          name: EditarEventoWidget.routeName,
          path: EditarEventoWidget.routePath,
