...
class PerfilWidget extends StatefulWidget {
  const PerfilWidget({
    super.key,
    String? fechaActual,
  }) : this.fechaActual = fechaActual ?? '19/5/6/2025';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsuariosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosRecord> perfilUsuariosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final perfilUsuariosRecord = perfilUsuariosRecordList.isNotEmpty
            ? perfilUsuariosRecordList.first
            : null;
